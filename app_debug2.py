...
@app.route("/")
def index():
    app.logger.info('aa22 Serving index page.')
...
async def signalk_listener():
    app.logger.info("aa40 signalk_listener started.")
        ...
        async with websockets.connect(url) as websocket:
            while True:
                ...
                try:
                    ...
                    app.logger.debug(f"aa48 Parsed data: {data}")  # Log parsed JSON
                ...
                if updates:
                    ...
                    app.logger.info(f"aa102 Emitted data: {updates}")
    except Exception as e:
        app.logger.error(f"aa105 Error in signalk_listener: {e}")
